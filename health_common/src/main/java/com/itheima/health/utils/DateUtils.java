...
public class DateUtils {
    ...
    public static void main(String[] args) {
        try {
            System.out.println("本周一" + parseDate2String(getLastDay4ThisMonth()));
     ...
     * @return
     */
    public static String getDateOfThisMonthLast(int year, int month, int day) {
        Calendar calendar = Calendar.getInstance();
        calendar.set(year, (month - 1), day);
        calendar.set(Calendar.DAY_OF_MONTH, calendar.getActualMaximum(Calendar.DAY_OF_MONTH));
        try {
            String dateAfter = DateUtils.parseDate2String(calendar.getTime());
     ...
     * @return
     */
    public static String getDateOfThisMonthFirst(int year, int month, int day) {
        Calendar calendar = Calendar.getInstance();
        calendar.set(year, (month - 1), day);
