...
public class MessageConstant {
    ...
    public static final String EDIT_MENU_FAIL = "编辑菜单项失败";
    ...
    public static final String CHECK_ROLE_MENU_FAIL = "当前角色和菜单项存在关联关系，不能删除";
    ...
    public static final String DELETE_ROLE_FAIL = "删除角色成功";
    public static final String CHECK_ROLE_PERMISSION_FAIL = "当前角色和权限存在关联关系，不能删除";
    ...
    public static final String DELETE_USER_FAIL = "查询用户失败";
}
